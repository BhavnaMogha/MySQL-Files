...
ba.Balance_amount , br.Account_Number as RD_Account_number, sum(bt.Transaction_amount) as RD_transaction_Amt
...
Where br.Account_type 	like 'RECURRING DEPOSITS'    
group by ba.Account_Number, ba.Account_type  ,ba.Balance_amount, br.Account_Number;
*/

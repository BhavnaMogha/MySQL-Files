...
--  SELECT*FROM cricket_1 WHERE Player_Name  LIKE '__y%';
-- --------------------------------------------------------
...
# from the table “Churn_Details ” where the value of the column “InternetConnection” has ‘i’ at the second position.
